...
import { GRADES, GRADE_LABELS, CORPS_METIERS, ROLES_ASSOC, type Grade } from "@/lib/supabase-helpers";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Votre demande d'adhésion a bien été enregistrée. Un administrateur doit la valider avant que vous puissiez vous connecter.",
      });
      navigate("/");
    } catch (err: any) {
